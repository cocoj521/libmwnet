...
class CMsgFilesImpl : public CMsgFiles
{
public:
	CMsgFilesImpl();
	virtual ~CMsgFilesImpl() = default;
...
public:
	...
	virtual int  InitMsgFiles(const std::string& szPtCode = "UNKNOWN",
	                                   int ptCode = 0,
	                                   int gateNo = 0,
