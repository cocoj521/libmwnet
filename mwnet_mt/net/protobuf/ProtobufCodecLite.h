...
#ifndef MWNET_MT_NET_PROTOBUF_CODEC_H
#define MWNET_MT_NET_PROTOBUF_CODEC_H
...
class ProtobufCodecLite : noncopyable
{
 public:
  ...
  void fillEmptyBuffer(mwnet_mt::net::Buffer* buf, const google::protobuf::Message& message);
...
class ProtobufCodecLiteT
{
 ...
 public:
  ...
  void onRpcMessage(const TcpConnectionPtr& conn,
                    ...
                    Timestamp receiveTime)
  {
    messageCallback_(conn, ::mwnet_mt::down_pointer_cast<MSG>(message), receiveTime);
  }

  void fillEmptyBuffer(mwnet_mt::net::Buffer* buf, const MSG& message)
  {
...
#endif  // MWNET_MT_NET_PROTOBUF_CODEC_H
