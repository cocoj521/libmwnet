                ...
                mwnet_mt::noncopyable
{
 public:
  ...
  void headerOnly();
  void setRange(const mwnet_mt::StringArg range);
...
class Curl : mwnet_mt::noncopyable
{
 public:
  ...
  explicit Curl(mwnet_mt::net::EventLoop* loop);
  ~Curl();

  RequestPtr getUrl(mwnet_mt::StringArg url);
